...
public record CreateSessionRequest(
    [Required(ErrorMessage = "Vui lòng chọn lịch học.")] int    ScheduleId,
    [Required(ErrorMessage = "Vui lòng nhập ngày học.")] DateOnly SessionDate,
...
public record ScanQRRequest(
    [Required(ErrorMessage = "Mã QR không hợp lệ.")] Guid QRToken,
...
public record UpdateAttendanceRequest(
    [Required(ErrorMessage = "Vui lòng chọn học sinh.")] int StudentId,
    [Required(ErrorMessage = "Vui lòng chọn trạng thái điểm danh.")] AttendanceStatus Status,
    string? Note
);
